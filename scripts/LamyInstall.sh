...
wget https://github.com/Otakuhime167/Eraser/raw/main/RemarkableLamyEraser
...
wget https://github.com/Otakuhime167/Eraser/raw/main/config/LamyEraser.conf
...
if [[ $REPLY =~ ^[Yy]$ ]]
 then
  ...
  wget https://github.com/Otakuhime167/Eraser/raw/main/config/LamyEraser.service
